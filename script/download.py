...
fold_name = 'GooglePatent202310'
file_name = 'delta_*.gz'
project = 'patents-public-data'
dataset_id = 'patents'
table_id = 'publications_202304'

destination_uri = 'gs://{}/{}'.format(bucket_name, fold_name + '/' + file_name)
...
''' The following codes used to extract data from table to GCS, since
    we've already done this extraction in Bigquery Platform, we ignore
    this step here.
